...
<body>
    ...
    <h1 style=" margin-top: 30px; margin-left: 20px;">Image Gallery</h1>

    <div class="image-gallery" style=" margin-top: 30px; margin-left: 10px;">
        <!-- Image 1 -->
        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im1.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im2.png" alt="Image " width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im3.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im4.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im5.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im6.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im7.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im8.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im9.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im10.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im11.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im12.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im13.png" alt="Image 1" width="700px" height="600px">
            <img src="./img/im14.png" alt="Image 1" width="700px" height="600px">
        </div>

        <div class="image-container" style=" margin-top: 30px; margin-left: 10px;">
            <img src="./img/im15.png" alt="Image 1" width="700px" height="600px">
        </div>
